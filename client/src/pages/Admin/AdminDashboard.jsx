...
import { Users, UserPlus, Activity, Database, Download, Search } from 'lucide-react';
import toast from 'react-hot-toast';
import VerifyDoctorsTable from '../../components/admin/VerifyDoctorsTable';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
      ...
      <div className="mb-8">
        <div className="relative max-w-xl">
          ...
          <input
            ...
            placeholder="Global search for Doctors, Patients, or Appointments..."
            value={searchQuery}
      ...
      <div className="glass rounded-xl p-6 border border-slate-200 shadow-sm">
        ...
        <div className="text-center py-12 text-gray-500 bg-slate-50 rounded-lg border border-dashed border-slate-300">
          Advanced analytics charts and audit logs will render here.
        </div>
      </div>
    </div>
  );
